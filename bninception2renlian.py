...
class BNInception(nn.Module):
    ...
    def __init__(self, num_classes=68):  #输入256 大小特征图
        ...
        self.conv2_3x3 = nn.Conv2d(64, 96, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))   #63*63 *96 通道数增加
        self.conv2_3x3_bn = nn.BatchNorm2d(96, affine=True)
        self.conv2_relu_3x3 = nn.ReLU (inplace)
        self.pool2_3x3_s2 = nn.MaxPool2d ((3, 3), stride=(2, 2), dilation=(1, 1), ceil_mode=True)  #k=5, 30*30 *96
        #开始inception1_a
        self.inception_3a_1x1 = nn.Conv2d(96, 16, kernel_size=(1, 1), stride=(1, 1))  #30*30 *64 降通道数两个分支先1*1卷积
        self.inception_3a_1x1_bn = nn.BatchNorm2d(16, affine=True)
        self.inception_3a_relu_1x1 = nn.ReLU (inplace)
		
        self.inception_3a_3x3_reduce = nn.Conv2d(96, 48, kernel_size=(1, 1), stride=(1, 1))  #另一分支降通道数  30*30 *64
        self.inception_3a_3x3_reduce_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_3a_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_3a_3x3 = nn.Conv2d(48, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  #再3*3conv , 30*30 *32
        self.inception_3a_3x3_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_3a_relu_3x3 = nn.ReLU (inplace)

        self.inception_3a_double_3x3_reduce = nn.Conv2d(96, 32, kernel_size=(1, 1), stride=(1, 1))  #30*30 *64
        self.inception_3a_double_3x3_reduce_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_3a_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_3a_double_3x3_1 = nn.Conv2d(32, 32, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  #30*30 *32
        self.inception_3a_double_3x3_1_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_3a_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_3a_double_3x3_2 = nn.Conv2d(32, 48, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  #30*30 *96
        self.inception_3a_double_3x3_2_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_3a_relu_double_3x3_2 = nn.ReLU (inplace)
		
        self.inception_3a_pool = nn.AvgPool2d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)  #3*3核大小，30*30 *96
        self.inception_3a_pool_proj = nn.Conv2d(96, 16, kernel_size=(1, 1), stride=(1, 1))  #30*30 *32
        self.inception_3a_pool_proj_bn = nn.BatchNorm2d(16, affine=True) 
        self.inception_3a_relu_pool_proj = nn.ReLU (inplace)
		 #开始inception1_b
        self.inception_3b_1x1 = nn.Conv2d(144, 32, kernel_size=(1, 1), stride=(1, 1))    #30*30 *64
        self.inception_3b_1x1_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_3b_relu_1x1 = nn.ReLU (inplace)
		
        self.inception_3b_3x3_reduce = nn.Conv2d(144, 32, kernel_size=(1, 1), stride=(1, 1))   #30*30 *64
        self.inception_3b_3x3_reduce_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_3b_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_3b_3x3 = nn.Conv2d(32, 48, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  #30*30 *96
        self.inception_3b_3x3_bn = nn.BatchNorm2d(48 affine=True)
        self.inception_3b_relu_3x3 = nn.ReLU (inplace)
		
        self.inception_3b_double_3x3_reduce = nn.Conv2d(144, 48, kernel_size=(1, 1), stride=(1, 1))  #30*30 *64
        self.inception_3b_double_3x3_reduce_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_3b_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_3b_double_3x3_1 = nn.Conv2d(48, 48, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))   #30*30 *96
        self.inception_3b_double_3x3_1_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_3b_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_3b_double_3x3_2 = nn.Conv2d(48, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))      #30*30 *96
        self.inception_3b_double_3x3_2_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_3b_relu_double_3x3_2 = nn.ReLU (inplace)
		
        self.inception_3b_pool = nn.AvgPool2d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)   #30*30 *96
        self.inception_3b_pool_proj = nn.Conv2d(144, 32, kernel_size=(1, 1), stride=(1, 1))   #30*30 *64
        self.inception_3b_pool_proj_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_3b_relu_pool_proj = nn.ReLU (inplace)
		#开始inception1_c
        self.inception_3c_3x3_reduce = nn.Conv2d(176, 48, kernel_size=(1, 1), stride=(1, 1))   #30*30 *128
        self.inception_3c_3x3_reduce_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_3c_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_3c_3x3 = nn.Conv2d(48, 32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1))     #16*16 *160
        self.inception_3c_3x3_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_3c_relu_3x3 = nn.ReLU (inplace)
		
        self.inception_3c_double_3x3_reduce = nn.Conv2d(176, 64, kernel_size=(1, 1), stride=(1, 1))     #30*30 *64
        self.inception_3c_double_3x3_reduce_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_3c_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_3c_double_3x3_1 = nn.Conv2d(64, 32, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))       #30*30 *96
        self.inception_3c_double_3x3_1_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_3c_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_3c_double_3x3_2 = nn.Conv2d(32, 48, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1))       #16*16 *96
        self.inception_3c_double_3x3_2_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_3c_relu_double_3x3_2 = nn.ReLU (inplace)
		
        self.inception_3c_pool = nn.MaxPool2d ((3, 3), stride=(2, 2), dilation=(1, 1), ceil_mode=True)        #7*7 *96
		#开始inception1_4a
        self.inception_4a_1x1 = nn.Conv2d(256, 64, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4a_1x1_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_4a_relu_1x1 = nn.ReLU (inplace)
		
        self.inception_4a_3x3_reduce = nn.Conv2d(256, 48, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4a_3x3_reduce_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_4a_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4a_3x3 = nn.Conv2d(48, 80, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4a_3x3_bn = nn.BatchNorm2d(80, affine=True)
        self.inception_4a_relu_3x3 = nn.ReLU (inplace)
		
        self.inception_4a_double_3x3_reduce = nn.Conv2d(256, 96, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4a_double_3x3_reduce_bn = nn.BatchNorm2d(96, affine=True)
        self.inception_4a_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_4a_double_3x3_1 = nn.Conv2d(96, 32, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4a_double_3x3_1_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_4a_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_4a_double_3x3_2 = nn.Conv2d(32, 48, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4a_double_3x3_2_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_4a_relu_double_3x3_2 = nn.ReLU (inplace)
		
        self.inception_4a_pool = nn.AvgPool2d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_4a_pool_proj = nn.Conv2d(256, 64, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4a_pool_proj_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_4a_relu_pool_proj = nn.ReLU (inplace)
		#开始inception1_4b
        self.inception_4b_1x1 = nn.Conv2d(256, 48, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4b_1x1_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_4b_relu_1x1 = nn.ReLU (inplace)
		
        self.inception_4b_3x3_reduce = nn.Conv2d(256, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4b_3x3_reduce_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_4b_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4b_3x3 = nn.Conv2d(32, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4b_3x3_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_4b_relu_3x3 = nn.ReLU (inplace)
		
        self.inception_4b_double_3x3_reduce = nn.Conv2d(256, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4b_double_3x3_reduce_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_4b_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_4b_double_3x3_1 = nn.Conv2d(32, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4b_double_3x3_1_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_4b_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_4b_double_3x3_2 = nn.Conv2d(64, 96, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4b_double_3x3_2_bn = nn.BatchNorm2d(96, affine=True)
        self.inception_4b_relu_double_3x3_2 = nn.ReLU (inplace)
		
        self.inception_4b_pool = nn.AvgPool2d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_4b_pool_proj = nn.Conv2d(256, 48, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4b_pool_proj_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_4b_relu_pool_proj = nn.ReLU (inplace)
		#开始inception1_4c
        self.inception_4c_1x1 = nn.Conv2d(256, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4c_1x1_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_4c_relu_1x1 = nn.ReLU (inplace)
		
        self.inception_4c_3x3_reduce = nn.Conv2d(256, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4c_3x3_reduce_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_4c_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4c_3x3 = nn.Conv2d(32, 48, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4c_3x3_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_4c_relu_3x3 = nn.ReLU (inplace)
		
        self.inception_4c_double_3x3_reduce = nn.Conv2d(256, 96, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4c_double_3x3_reduce_bn = nn.BatchNorm2d(96, affine=True)
        self.inception_4c_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_4c_double_3x3_1 = nn.Conv2d(96, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4c_double_3x3_1_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_4c_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_4c_double_3x3_2 = nn.Conv2d(64, 112, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4c_double_3x3_2_bn = nn.BatchNorm2d(112, affine=True)
        self.inception_4c_relu_double_3x3_2 = nn.ReLU (inplace)
	
        self.inception_4c_pool = nn.AvgPool2d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_4c_pool_proj = nn.Conv2d(256, 64, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4c_pool_proj_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_4c_relu_pool_proj = nn.ReLU (inplace)
		#开始inception1_4d
        self.inception_4d_1x1 = nn.Conv2d(272, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4d_1x1_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_4d_relu_1x1 = nn.ReLU (inplace)
		
        self.inception_4d_3x3_reduce = nn.Conv2d(272, 64, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4d_3x3_reduce_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_4d_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4d_3x3 = nn.Conv2d(64, 96, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4d_3x3_bn = nn.BatchNorm2d(96, affine=True)
        self.inception_4d_relu_3x3 = nn.ReLU (inplace)
		
        self.inception_4d_double_3x3_reduce = nn.Conv2d(272, 96, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4d_double_3x3_reduce_bn = nn.BatchNorm2d(96, affine=True)
        self.inception_4d_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_4d_double_3x3_1 = nn.Conv2d(96, 96, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4d_double_3x3_1_bn = nn.BatchNorm2d(96, affine=True)
        self.inception_4d_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_4d_double_3x3_2 = nn.Conv2d(96, 112 kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4d_double_3x3_2_bn = nn.BatchNorm2d(112, affine=True)
        self.inception_4d_relu_double_3x3_2 = nn.ReLU (inplace)
		
        self.inception_4d_pool = nn.AvgPool2d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_4d_pool_proj = nn.Conv2d(272, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4d_pool_proj_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_4d_relu_pool_proj = nn.ReLU (inplace)
		#开始inception1_4e
        self.inception_4e_3x3_reduce = nn.Conv2d(272, 16, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4e_3x3_reduce_bn = nn.BatchNorm2d(16, affine=True)
        self.inception_4e_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4e_3x3 = nn.Conv2d(16, 32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1))
        self.inception_4e_3x3_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_4e_relu_3x3 = nn.ReLU (inplace)
		
        self.inception_4e_double_3x3_reduce = nn.Conv2d(272, 48, kernel_size=(1, 1), stride=(1, 1))
        self.inception_4e_double_3x3_reduce_bn = nn.BatchNorm2d(48, affine=True)
        self.inception_4e_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_4e_double_3x3_1 = nn.Conv2d(48, 16, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_4e_double_3x3_1_bn = nn.BatchNorm2d(16, affine=True)
        self.inception_4e_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_4e_double_3x3_2 = nn.Conv2d(16, 32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1))
        self.inception_4e_double_3x3_2_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_4e_relu_double_3x3_2 = nn.ReLU (inplace)
		
        self.inception_4e_pool = nn.MaxPool2d ((3, 3), stride=(2, 2), dilation=(1, 1), ceil_mode=True)
		#开始inception1_5a
        self.inception_5a_1x1 = nn.Conv2d(336, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_5a_1x1_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_5a_relu_1x1 = nn.ReLU (inplace)
		
        self.inception_5a_3x3_reduce = nn.Conv2d(336, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_5a_3x3_reduce_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_5a_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_5a_3x3 = nn.Conv2d(32, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_5a_3x3_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_5a_relu_3x3 = nn.ReLU (inplace)
		
        self.inception_5a_double_3x3_reduce = nn.Conv2d(336, 64, kernel_size=(1, 1), stride=(1, 1))
        self.inception_5a_double_3x3_reduce_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_5a_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_5a_double_3x3_1 = nn.Conv2d(64, 238, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_5a_double_3x3_1_bn = nn.BatchNorm2d(128, affine=True)
        self.inception_5a_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_5a_double_3x3_2 = nn.Conv2d(128, 128, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_5a_double_3x3_2_bn = nn.BatchNorm2d(128, affine=True)
        self.inception_5a_relu_double_3x3_2 = nn.ReLU (inplace)
		
        self.inception_5a_pool = nn.AvgPool2d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_5a_pool_proj = nn.Conv2d(336, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_5a_pool_proj_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_5a_relu_pool_proj = nn.ReLU (inplace)
		#开始inception1_5b
        self.inception_5b_1x1 = nn.Conv2d(256, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_5b_1x1_bn = nn.BatchNorm2d(32, affine=True)
        self.inception_5b_relu_1x1 = nn.ReLU (inplace)
		
        self.inception_5b_3x3_reduce = nn.Conv2d(256, 96, kernel_size=(1, 1), stride=(1, 1))
        self.inception_5b_3x3_reduce_bn = nn.BatchNorm2d(96, affine=True)
        self.inception_5b_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_5b_3x3 = nn.Conv2d(96, 128, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_5b_3x3_bn = nn.BatchNorm2d(128, affine=True)
        self.inception_5b_relu_3x3 = nn.ReLU (inplace)
		
        self.inception_5b_double_3x3_reduce = nn.Conv2d(256, 96, kernel_size=(1, 1), stride=(1, 1))
        self.inception_5b_double_3x3_reduce_bn = nn.BatchNorm2d(96, affine=True)
        self.inception_5b_relu_double_3x3_reduce = nn.ReLU (inplace)
        self.inception_5b_double_3x3_1 = nn.Conv2d(96, 96, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_5b_double_3x3_1_bn = nn.BatchNorm2d(96, affine=True)
        self.inception_5b_relu_double_3x3_1 = nn.ReLU (inplace)
        self.inception_5b_double_3x3_2 = nn.Conv2d(96, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.inception_5b_double_3x3_2_bn = nn.BatchNorm2d(64, affine=True)
        self.inception_5b_relu_double_3x3_2 = nn.ReLU (inplace)
		
        self.inception_5b_pool = nn.MaxPool2d ((3, 3), stride=(1, 1), padding=(1, 1), dilation=(1, 1), ceil_mode=True)
        self.inception_5b_pool_proj = nn.Conv2d(256, 32, kernel_size=(1, 1), stride=(1, 1))
        self.inception_5b_pool_proj_bn = nn.BatchNorm2d(32, affine=True)
